...
>
  <div style={{ textAlign: "right" }}>Old</div>
  <div>
...
<ul style={{ fontSize: "32px" }}>
  <li>
    No more <code>event.prefentDefault()</code> on form
    submissions.
  </li>
  <li>
    No more spinnerama as you make 5 separate client side
    requests for data.
  </li>
  <li>Heck, no more clientside code if you want.</li>
</ul>
